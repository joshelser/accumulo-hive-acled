...
public class SourceCountJob extends Configured implements Tool {
  ...
  public int run(String[] args) throws Exception {
    ...
    Job job = Job.getInstance(conf, "Count distinct sources in ACLED");

    AccumuloInputFormat.setConnectorInfo(job, user, new PasswordToken(pass));
    AccumuloInputFormat.setZooKeeperInstance(job, ClientConfiguration.loadDefault().withInstance(instanceName).withZkHosts(zooQuorum));
  ...
  private Path clearOutputDir(String outputStr) throws IOException {
  ...
  public static class ACLEDSourceMapper extends Mapper<Key,Value,Text,IntWritable> {
  ...
  public static class ACLEDSourceReducer extends Reducer<Text,IntWritable,Text,IntWritable> {
